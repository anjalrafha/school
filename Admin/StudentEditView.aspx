<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="false" CodeFile="StudentEditView.aspx.vb" Inherits="Admin_StudentEditView" %>
    ...
    <table cellpadding="2" class="style3">
        <tr>
            <td align="center" bgcolor="#F2F2F2">
                <asp:Label ID="Lbmsg" runat="server" Text="تفاصيل الطالب"></asp:Label>
            </td>
        </tr>
        <tr>
            <td align="right">
        ...
        <tr>
            <td align="right">
                <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
                    ...
                    <Fields>
                        ...
                        <asp:TemplateField HeaderText="اسم الطالب" SortExpression="StudentName">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox8" runat="server" Text='<%# Bind("StudentName") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <InsertItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="تاريخ الميلاد" SortExpression="StudentBirth">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox9" runat="server" Text='<%# Bind("StudentBirth") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <InsertItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="عنوان الطالب" SortExpression="StudentAddrss">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox10" runat="server" Text='<%# Bind("StudentAddrss") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <InsertItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="اسم ولي الأمر" SortExpression="GuardianName">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox11" runat="server" Text='<%# Bind("GuardianName") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <InsertItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="هاتف ولي الأمر" SortExpression="GuardianPhone">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox12" runat="server" Text='<%# Bind("GuardianPhone") %>'></asp:TextBox>
                            </EditItemTemplate>
                            <InsertItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="البريد الإلكتروني لولي الأمر" 
                            ...
                            <InsertItemTemplate>
                                <asp:TextBox ID="TextBox13" runat="server" Text='<%# Bind("GuardianEmail") %>'></asp:TextBox>
                            </InsertItemTemplate>
                            <ItemTemplate>
                                <asp:Label ID="Label8" runat="server" Text='<%# Bind("GuardianEmail") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ...
                    SelectCommand="SELECT * FROM [TaStudent] WHERE ([StudentIDNat] = @StudentIDNat)" 
